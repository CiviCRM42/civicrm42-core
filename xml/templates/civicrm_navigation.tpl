...
VALUES     
    ...
    ( @domainID, 'civicrm/batch&reset=1',                       '{ts escape="sql" skip="true"}Bulk Data Entry{/ts}',     'Bulk Data Entry',             'access CiviContribute', '', @contributionlastID, '1', NULL, 4 ), 
...
VALUES    
    ...
    ( @domainID, 'civicrm/batch&reset=1',                       '{ts escape="sql" skip="true"}Bulk Data Entry{/ts}',    'Bulk Data Entry','access CiviContribute', '', @memberlastID, '1', NULL, 4 ), 
