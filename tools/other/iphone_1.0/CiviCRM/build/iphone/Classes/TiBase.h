...
// in simulator we redefine to format for CiviCRM Developer console
...
{\
	NSString * exceptionName = [@"org.civicrm." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.civicrm";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UICiviCRMNativeItemNone = -1, 
	UICiviCRMNativeItemSpinner = -2,
	UICiviCRMNativeItemProgressBar = -3,
	
	UICiviCRMNativeItemSlider = -4,
	UICiviCRMNativeItemSwitch = -5,
	UICiviCRMNativeItemMultiButton = -6,
	UICiviCRMNativeItemSegmented = -7,
	
	UICiviCRMNativeItemTextView = -8,
	UICiviCRMNativeItemTextField = -9,
	UICiviCRMNativeItemSearchBar = -10,
	
	UICiviCRMNativeItemPicker = -11,
	UICiviCRMNativeItemDatePicker = -12,
	
	UICiviCRMNativeItemInfoLight = -13,
	UICiviCRMNativeItemInfoDark = -14,
	
	UICiviCRMNativeItemDisclosure = -15,
	
	UICiviCRMNativeItemContactAdd = -16
};
